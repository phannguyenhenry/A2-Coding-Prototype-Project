...
#Main Game Loop
    while running: 
        ...
        accuracy = round(hit_counter / (hit_counter + miss_counter) * 100) if hit_counter > 0 else 0 #Calculates the accuracy percentage based on successful hits divided by total clicks (hit_counter + miss_counter) #The if hit_counter > 0 else 0 accounts for the division by zero error
