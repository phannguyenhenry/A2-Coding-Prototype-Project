...
def main_menu(): #The Main Menu loop, operating under a define function
    while True:
        ...
        screen.blit(game1text, (button_1 - game1text.get_width()/2, button_1.centery - game1text.get_height()/2)) #The centerx and centery string works to center the display blit to according to the x and y's of the screen
        screen.blit(game2text, (button_2 - game2text.get_width()/2, button_2.centery - game2text.get_height()/2))
